...
public class StoreSpell {
	...
	public static void createSpell(int id, String sprite_id, String name, int effectValue, int manaCost, float stunRate, int stunDuration, int cd, int castTime, boolean triggerGCD) {
		if(id == 1) {			//deathCoil
