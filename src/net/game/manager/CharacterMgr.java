...
import net.command.player.CommandSendCharacterStats;
...
public class CharacterMgr
{
	...
	private final static SQLTask fullyLoadCharacter = new SQLTask("Fully load character", false)
	{
		...
		public void gatherData()
		{
			...
			CommandSendCharacterStats.write(player);
	...
	public static void loadCharacterInfo(Player player)
	{
		...
		for (int i = 0; i < player.getStuff().length; ++i)
		{
	...
	//TODO: Move this in ClassType enum
	...
	//TODO: Add a constructor to ClassType to store a String
