...
public class ProfessionManager {
	...
	public static void LoadAllCraft() throws SQLException {	
		...
		while(loadAllCraft.fetch()) {
			...
			Item ressource1 = Item.getItem(Integer.parseInt(tempItem.split(":")[0]));
			int ressource1Amount = Integer.valueOf(tempItem.split(":")[1]);
			tempItem = loadAllCraft.getString();
			Item ressource2 = Item.getItem(Integer.parseInt(tempItem.split(":")[0]));
			int ressource2Amount = Integer.valueOf(tempItem.split(":")[1]);
			tempItem = loadAllCraft.getString();
			Item ressource3 = Item.getItem(Integer.parseInt(tempItem.split(":")[0]));
			int ressource3Amount = Integer.valueOf(tempItem.split(":")[1]);
			tempItem = loadAllCraft.getString();
			Item ressource4 = Item.getItem(Integer.parseInt(tempItem.split(":")[0]));
			int ressource4Amount = Integer.valueOf(tempItem.split(":")[1]);
			tempItem = loadAllCraft.getString();
			Item ressource5 = Item.getItem(Integer.parseInt(tempItem.split(":")[0]));
			int ressource5Amount = Integer.valueOf(tempItem.split(":")[1]);
			tempItem = loadAllCraft.getString();
			Item ressource6 = Item.getItem(Integer.parseInt(tempItem.split(":")[0]));
