...
public class SellItemRequest implements AuctionHouseTask {
	...
	private final AuctionHouseInitialDuration duration;

	public SellItemRequest(Player player, Item item, int buyoutPrice, int bidPrice, AuctionHouseInitialDuration duration) {
		this.player = player;
		this.item = item;
